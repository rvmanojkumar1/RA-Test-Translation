						...
						if($questiontype=='multichoiceoneans'){
			    			...
			    			if ($quid->rowCount() > 0)
						    {
						    	...
						    	for($j=0;$j<count($_POST['multipleinput'][$i]['answer']);$j++){
						    		...
						    		if(array_key_exists('case'.$j,$_POST['multipleinput'][$i]['answer']['option'.$j]))
							    	{
							    		$sqloptionquery="INSERT INTO public.options (title, question_id) VALUES ('".translate_text('kn',$_POST['multipleinput'][$i]['answer']['option'.$j][$j])."', '".$questionid['id']."') returning id";
													...
													if($casequestiontype=='multichoiceoneans'){
										    			...
										    			if ($quid->rowCount() > 0)
													    {
													    	...
													    	for($m=0;$m<count($_POST['multipleinput'][$i]['answer']['option'.$j]['case'.$j][$k]['answers2']);$m++){
													    		...
													    		$sql3="INSERT INTO public.options (title, question_id) VALUES ('".translate_text('kn',$_POST['multipleinput'][$i]['answer']['option'.$j]['case'.$j][$k]['answers2']['option'.$m][$m])."', '".$casequestionid['id']."')";
							    		...
							    		$sql3="INSERT INTO public.options (title, question_id) VALUES ('".translate_text('kn',$_POST['multipleinput'][$i]['answer']['option'.$j][$j])."', '".$questionid['id']."')";
						...
						if($questiontype=='multichoiceoneans'){
			    			...
			    			if ($quid->rowCount() > 0)
						    {
						    	...
						    	for($j=0;$j<count($_POST['multipleinput'][$i]['answer']);$j++){
						    		...
						    		if(array_key_exists('case'.$j,$_POST['multipleinput'][$i]['answer']['option'.$j]))
							    	{
							    		$sqloptionquery="INSERT INTO public.options (title, question_id) VALUES ('".translate_text('bn',$_POST['multipleinput'][$i]['answer']['option'.$j][$j])."', '".$questionid['id']."') returning id";
													...
													if($casequestiontype=='multichoiceoneans'){
										    			...
										    			if ($quid->rowCount() > 0)
													    {
													    	...
													    	for($m=0;$m<count($_POST['multipleinput'][$i]['answer']['option'.$j]['case'.$j][$k]['answers2']);$m++){
													    		...
													    		$sql3="INSERT INTO public.options (title, question_id) VALUES ('".translate_text('bn',$_POST['multipleinput'][$i]['answer']['option'.$j]['case'.$j][$k]['answers2']['option'.$m][$m])."', '".$casequestionid['id']."')";
							    		...
							    		$sql3="INSERT INTO public.options (title, question_id) VALUES ('".translate_text('bn',$_POST['multipleinput'][$i]['answer']['option'.$j][$j])."', '".$questionid['id']."')";
						...
						if($questiontype=='multichoiceoneans'){
			    			...
			    			if ($quid->rowCount() > 0)
						    {
						    	...
						    	for($j=0;$j<count($_POST['multipleinput'][$i]['answer']);$j++){
						    		...
						    		if(array_key_exists('case'.$j,$_POST['multipleinput'][$i]['answer']['option'.$j]))
							    	{
							    		$sqloptionquery="INSERT INTO public.options (title, question_id) VALUES ('".translate_text('mr',$_POST['multipleinput'][$i]['answer']['option'.$j][$j])."', '".$questionid['id']."') returning id";
													...
													if($casequestiontype=='multichoiceoneans'){
										    			...
										    			if ($quid->rowCount() > 0)
													    {
													    	...
													    	for($m=0;$m<count($_POST['multipleinput'][$i]['answer']['option'.$j]['case'.$j][$k]['answers2']);$m++){
													    		...
													    		$sql3="INSERT INTO public.options (title, question_id) VALUES ('".translate_text('mr',$_POST['multipleinput'][$i]['answer']['option'.$j]['case'.$j][$k]['answers2']['option'.$m][$m])."', '".$casequestionid['id']."')";
							    		...
							    		$sql3="INSERT INTO public.options (title, question_id) VALUES ('".translate_text('mr',$_POST['multipleinput'][$i]['answer']['option'.$j][$j])."', '".$questionid['id']."')";
						...
						if($questiontype=='multichoiceoneans'){
			    			...
			    			if ($quid->rowCount() > 0)
						    {
						    	...
						    	for($j=0;$j<count($_POST['multipleinput'][$i]['answer']);$j++){
						    		...
						    		if(array_key_exists('case'.$j,$_POST['multipleinput'][$i]['answer']['option'.$j]))
							    	{
							    		$sqloptionquery="INSERT INTO public.options (title, question_id) VALUES ('".translate_text('hi',$_POST['multipleinput'][$i]['answer']['option'.$j][$j])."', '".$questionid['id']."') returning id";
													...
													if($casequestiontype=='multichoiceoneans'){
										    			...
										    			if ($quid->rowCount() > 0)
													    {
													    	...
													    	for($m=0;$m<count($_POST['multipleinput'][$i]['answer']['option'.$j]['case'.$j][$k]['answers2']);$m++){
													    		...
													    		$sql3="INSERT INTO public.options (title, question_id) VALUES ('".translate_text('hi',$_POST['multipleinput'][$i]['answer']['option'.$j]['case'.$j][$k]['answers2']['option'.$m][$m])."', '".$casequestionid['id']."')";
							    		...
							    		$sql3="INSERT INTO public.options (title, question_id) VALUES ('".translate_text('hi',$_POST['multipleinput'][$i]['answer']['option'.$j][$j])."', '".$questionid['id']."')";
